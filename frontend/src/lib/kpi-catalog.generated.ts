...
export const KPI_CATALOG: readonly KpiCatalogEntry[] = [
  ...
  {"id": "WS3-BI-005", "key": "trx", "name": "Total Prescriptions (TRx)", "workstream": "ws3_business", "semanticType": "Number", "aliases": ["total_prescriptions", "total_prescriptions_(trx)", "trx", "ws3_bi_005"]},
  {"id": "WS3-BI-006", "key": "nrx", "name": "New Prescriptions (NRx)", "workstream": "ws3_business", "semanticType": "Number", "aliases": ["new_prescriptions", "new_prescriptions_(nrx)", "nrx", "ws3_bi_006"]},
  {"id": "WS3-BI-007", "key": "nbrx", "name": "New-to-Brand Prescriptions (NBRx)", "workstream": "ws3_business", "semanticType": "Number", "aliases": ["nbrx", "new_to_brand_prescriptions", "new_to_brand_prescriptions_(nbrx)", "ws3_bi_007"]},
  {"id": "WS3-BI-008", "key": "trx_share", "name": "TRx Share", "workstream": "ws3_business", "semanticType": "Percentage", "aliases": ["trx_share", "ws3_bi_008"]},
  {"id": "WS3-BI-011", "key": "trx_panel", "name": "Observed Rx Events - Patient Panel TRx (TRx Panel)", "workstream": "ws3_business", "semanticType": "Count", "aliases": ["observed_rx_events_patient_panel_trx", "observed_rx_events_patient_panel_trx_(trx_panel)", "trx_panel", "ws3_bi_011"]},
  {"id": "WS3-BI-012", "key": "nrx_panel", "name": "Observed Rx Events - Patient Panel NRx (NRx Panel)", "workstream": "ws3_business", "semanticType": "Count", "aliases": ["nrx_panel", "observed_rx_events_patient_panel_nrx", "observed_rx_events_patient_panel_nrx_(nrx_panel)", "ws3_bi_012"]},
  {"id": "WS3-BI-013", "key": "nbrx_panel", "name": "Observed Rx Events - Patient Panel NBRx (NBRx Panel)", "workstream": "ws3_business", "semanticType": "Count", "aliases": ["nbrx_panel", "observed_rx_events_patient_panel_nbrx", "observed_rx_events_patient_panel_nbrx_(nbrx_panel)", "ws3_bi_013"]},
  {"id": "WS3-BI-014", "key": "trx_share_panel", "name": "Observed Rx Events - Patient Panel TRx Share (TRx Share Panel)", "workstream": "ws3_business", "semanticType": "Percentage", "target": 0.3, "aliases": ["observed_rx_events_patient_panel_trx_share", "observed_rx_events_patient_panel_trx_share_(trx_share_panel)", "trx_share_panel", "ws3_bi_014"]},
