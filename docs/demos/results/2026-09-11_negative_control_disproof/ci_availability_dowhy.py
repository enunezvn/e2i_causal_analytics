...
from src.agents.causal_impact.nodes.refutation import _reconstruction_nuisance_init_params, _SELECTOR_TO_DOWHY_METHOD
...
for method in methods:
    for t, o, cc in pairs:
        ...
        try:
            ...
            print(f"{method:38} {t:>18}->{o:<20} n={len(d)} value={float(est.value):+.4f} ci={ci.round(4).tolist()} fit={t1-t0:.1f}s ci={t2-t1:.1f}s")
