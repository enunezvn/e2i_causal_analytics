...
def minimal_vocabulary_data() -> Dict[str, Any]:
    ...
    """
    return {
        "metadata": {"version": "1.0.0-test", "description": "Test vocabulary"},
        "brands": {
        ...
        "aliases": {"TestBrand": ["tb", "testb", "test-brand"], "OtherBrand": ["ob", "other"]},
        "journey_stages": {
        ...
        "diagnosis_codes": {"pattern": r"[A-Z][0-9]{2}\.?[0-9]*"},
        # V5.1.0 additions
        ...
        "brand_icd10_mappings": {
            ...
            "mappings": {
                ...
                "OtherBrand": {"primary_indication": "Other Indication", "icd10_codes": ["D59.5"]},
            },
        },
        "brand_ndc_codes": {
        ...
        "entities": [
            {
                ...
                "properties": [
                    ...
                    {"name": "region", "type": "string", "required": True, "indexed": True},
                    {
                        "name": "risk_score",
                        "type": "float",
                        "required": False,
            ...
            },
            {
                ...
                "properties": [
                    ...
                    {"name": "specialty", "type": "string", "required": True, "indexed": True},
                    {"name": "priority_tier", "type": "integer", "required": False},
                ],
            },
            {
                "label": "Brand",
                ...
                "properties": [
                    {"name": "brand_id", "type": "string", "required": True, "unique": True},
        ...
        "relationships": [
            {
                ...
                "properties": [
                    ...
                    {"name": "visit_count", "type": "integer", "required": False},
                ],
            },
            {
                "type": "PRESCRIBED",
                ...
                "cardinality": "M:N",
                "properties": [
                    {"name": "prescription_date", "type": "datetime", "required": True},
            ...
            },
            {
                ...
                "to": "Brand",
                "cardinality": "1:N",
                "properties": [{"name": "volume", "type": "integer", "required": False}],
            },
        ]
    }
...
def mock_ontology_dir(
    tmp_path: Path, sample_node_types_yaml: Dict[str, Any], sample_edge_types_yaml: Dict[str, Any]
) -> Path:
    """
...
def mock_graph_with_confounders(mock_graph_client: MockGraphClient) -> MockGraphClient:
    ...
    confounder_result = MockQueryResult(
        result_set=[
...
def schema_with_missing_pk():
    ...
    entity = EntitySchema(
        label="BadEntity",
        properties=[PropertySchema(name="other_field", property_type=PropertyType.STRING)],
