...
ALLOWLIST: dict[str, int] = {
    ...
    "src/agents/orchestrator/nodes/dispatcher.py": 3773,
    ...
    "src/api/routes/chatbot_graph.py": 3215,
    "src/api/routes/chatbot_tools.py": 3077,
    "src/api/routes/copilotkit.py": 6150,
