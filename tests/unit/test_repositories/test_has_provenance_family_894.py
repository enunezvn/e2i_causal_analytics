...
def test_provenance_tagged_tables_match_migrations() -> None:
    """PROVENANCE_TAGGED_TABLES must be the 28 tables migrations 063/067/069
    (+ ml/036, #1974; + migrations/148, Lane A 2026-09-22) tagged — the
    loader's stale pre-063 subset hard-excluded causal_paths and
    ...
    expected = {
        ...
        "discovered_dags",
        # 148_optum_biologic_persistence_causal.sql (Lane A, 2026-09-22)
