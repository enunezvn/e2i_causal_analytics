...
Before proceeding, validate the plan file path.
...
if [ -z "$ARGUMENTS" ]; then
  ...
  echo ""
  echo "Usage: /core_piv_loop:execute <path-to-plan>"
  echo ""
  echo "Example: /core_piv_loop:execute .claude/PRPs/features/active/feature-name.md"
  echo ""
