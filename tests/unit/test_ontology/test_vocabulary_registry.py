...
class TestVocabularyRegistryEdgeCases:
    ...
    def test_constructor_direct_instantiation(self, minimal_vocabulary_data: Dict[str, Any]):
        """Test direct constructor instantiation (not via load)."""
        registry = VocabularyRegistry(minimal_vocabulary_data, version="direct-test")
    ...
    def test_concurrent_access_safety(self, mock_vocabulary_file: Path):
        ...
        instances = [VocabularyRegistry.load(str(mock_vocabulary_file)) for _ in range(10)]
