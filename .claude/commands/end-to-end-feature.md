...
if [ -z "$ARGUMENTS" ]; then
  ...
  echo ""
  echo "Usage: /end-to-end-feature <feature-description>"
  echo ""
  echo "Examples:"
  echo "  /end-to-end-feature \"Add user authentication\""
  echo "  /end-to-end-feature \"Implement real-time notifications\""
  exit 1
fi
