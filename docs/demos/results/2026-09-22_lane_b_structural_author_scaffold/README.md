...
| 7 | The node edit stays under the module-size ratchet | `disproofs.txt:9` — 4224 lines on the merged tree (ratchet pin 4224 in `tests/unit/test_tests_meta/test_module_size_ratchet.py`: main's 4225 less the one line the lane's provenance change saves; before the merge 4237 vs main's 4238; the provenance helper lives in `src/ml/causal_role_dgp/extractor.py`) |
