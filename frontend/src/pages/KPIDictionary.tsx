...
const SAMPLE_KPIS: KPIMetadata[] = [
  ...
  },
  {
    ...
    workstream: 'ws1_data_quality',
    tables: ['patient_journeys', 'reference_universe'],
    columns: ['region', 'source_share'],
    threshold: { target: 5, warning: 10, critical: 20 },
    unit: '%',
    frequency: 'weekly',
    primary_causal_library: 'none',
  },
  {
    ...
    workstream: 'ws1_data_quality',
    tables: ['data_source_tracking'],
    columns: ['ingested_ts', 'service_date'],
    threshold: { target: 3, warning: 7, critical: 14 },
    unit: 'days',
    frequency: 'daily',
    primary_causal_library: 'none',
  },
  {
    ...
    calculation_type: 'derived',
    workstream: 'ws1_data_quality',
    tables: ['ml_predictions', 'feature_store'],
    columns: ['feature_distribution'],
    threshold: { target: 0.1, warning: 0.2, critical: 0.25 },
    frequency: 'daily',
    primary_causal_library: 'none',
  ...
  },
  {
    ...
    workstream: 'ws1_model_performance',
    tables: ['ml_predictions'],
    columns: ['predicted_probability', 'actual_outcome'],
    threshold: { target: 0.15, warning: 0.25, critical: 0.35 },
    frequency: 'daily',
    primary_causal_library: 'none',
    note: 'Calibration metric',
  },
  {
    id: 'WS1-MP-006',
    ...
    workstream: 'ws1_model_performance',
    tables: ['ml_predictions'],
    columns: ['calibration_metrics'],
    threshold: { target: 1.0, warning: 0.8, critical: 0.6 },
    frequency: 'daily',
    primary_causal_library: 'none',
  },
  {
    id: 'WS1-MP-007',
    name: 'SHAP Coverage',
    definition: 'Percentage of predictions where Top-N features explain ≥τ% of total attribution',
    formula: 'count(top_n_shap ≥ τ) / total_predictions',
    calculation_type: 'derived',
    workstream: 'ws1_model_performance',
    tables: ['ml_predictions', 'shap_explanations'],
    columns: ['shap_values'],
    threshold: { target: 80, warning: 65, critical: 50 },
    unit: '%',
    frequency: 'daily',
    primary_causal_library: 'none',
    note: 'Explainability metric',
  },
  {
    id: 'WS1-MP-008',
    ...
    workstream: 'ws1_model_performance',
    tables: ['ml_predictions'],
    columns: ['label_quality_score'],
    threshold: { target: 0.80, warning: 0.60, critical: 0.40 },
    frequency: 'weekly',
    primary_causal_library: 'none',
    note: 'Data quality',
  },
  ...
  },
  {
    ...
    workstream: 'ws2_triggers',
    tables: ['triggers', 'treatment_events'],
    columns: ['trigger_timestamp', 'outcome_timestamp'],
    threshold: { target: 7, warning: 14, critical: 21 },
    unit: 'days',
    frequency: 'weekly',
    primary_causal_library: 'dowhy',
  },
  {
    ...
    definition: 'Percentage of presented recommendations accepted (not snoozed/overridden)',
    formula: '#accepted / #presented',
    calculation_type: 'direct',
    workstream: 'ws2_triggers',
    tables: ['triggers'],
    columns: ['trigger_status'],
  ...
  },
  {
    ...
    formula: 'date_prod - date_approve',
    calculation_type: 'direct',
    workstream: 'ws2_triggers',
    tables: ['deployment_metrics'],
    columns: ['approval_date', 'release_date'],
    threshold: { target: 3, warning: 7, critical: 14 },
    unit: 'days',
    frequency: 'weekly',
    primary_causal_library: 'none',
  ...
  },
  {
    ...
    definition: 'Percentage of releases requiring rollback or hotfix within 7 days',
    formula: '#rollbacks(7d) / #releases',
    calculation_type: 'direct',
    workstream: 'ws2_triggers',
    tables: ['deployment_metrics'],
    columns: ['rollback_count', 'release_count'],
    threshold: { target: 5, warning: 10, critical: 20 },
    unit: '%',
    frequency: 'weekly',
    primary_causal_library: 'none',
  ...
  },
  {
    ...
    definition: 'Percentage of fired alerts without intended outcome within T days',
    formula: '#NoOutcomeInT / #Triggers',
    calculation_type: 'direct',
    workstream: 'ws2_triggers',
    tables: ['triggers'],
    columns: ['trigger_status', 'outcome_within_window'],
    threshold: { target: 15, warning: 25, critical: 40 },
    unit: '%',
    frequency: 'weekly',
    primary_causal_library: 'dowhy',
  },
  ...
  },
  {
    id: 'WS3-BI-002',
    name: 'HCP Coverage',
    definition: 'Percentage of priority HCP list with ≥1 brand-aligned touch linked to triggers',
    formula: '%HCPs touched = touched_HCPs / target_HCPs',
    calculation_type: 'direct',
    workstream: 'ws3_business',
    tables: ['triggers', 'hcp_profiles'],
    columns: ['hcp_id', 'touch_count'],
    threshold: { target: 75, warning: 60, critical: 45 },
    unit: '%',
    frequency: 'weekly',
    primary_causal_library: 'dowhy',
  },
  {
    ...
    definition: 'Percentage of targeted patients receiving at least one intervention',
    formula: 'patients_touched / patients_targeted',
    calculation_type: 'direct',
    workstream: 'ws3_business',
    tables: ['patient_journeys', 'triggers'],
    columns: ['patient_id', 'intervention_count'],
    threshold: { target: 65, warning: 50, critical: 35 },
    unit: '%',
    frequency: 'weekly',
    primary_causal_library: 'dowhy',
  },
  {
    ...
    definition: 'Count of new prescriptions written in period',
    formula: "count(event_type = 'new_rx')",
    calculation_type: 'direct',
    workstream: 'ws3_business',
    tables: ['treatment_events'],
    columns: ['event_type', 'is_new_rx'],
    frequency: 'daily',
    primary_causal_library: 'dowhy',
  },
  {
    ...
    definition: 'Change in market share vs. prior period',
    formula: 'Δshare = share_current - share_prior',
    calculation_type: 'derived',
    workstream: 'ws3_business',
    tables: ['business_metrics'],
    columns: ['market_share', 'period'],
    threshold: { target: 2, warning: 0, critical: -2 },
    unit: 'pp',
    frequency: 'monthly',
    primary_causal_library: 'econml',
  },
  {
    id: 'WS3-BI-007',
    name: 'Treatment Persistence',
    definition: 'Percentage of patients remaining on therapy at 6 months',
    formula: 'patients_on_therapy_6m / patients_started',
    calculation_type: 'direct',
    workstream: 'ws3_business',
    tables: ['patient_journeys', 'treatment_events'],
    columns: ['persistence_status', 'start_date'],
    threshold: { target: 70, warning: 55, critical: 40 },
    unit: '%',
    frequency: 'monthly',
    primary_causal_library: 'dowhy',
  },
  {
    ...
    definition: 'Median days from diagnosis to first treatment',
    formula: 'median(treatment_start - diagnosis_date)',
    calculation_type: 'direct',
    workstream: 'ws3_business',
    tables: ['patient_journeys'],
    columns: ['diagnosis_date', 'treatment_start_date'],
  ...
  },
  {
    ...
    definition: 'Percentage of target patients converting to brand therapy',
    formula: 'patients_converted / patients_targeted',
    calculation_type: 'derived',
    workstream: 'ws3_business',
    tables: ['patient_journeys', 'triggers'],
    columns: ['conversion_status'],
    threshold: { target: 25, warning: 15, critical: 8 },
    unit: '%',
    frequency: 'weekly',
    primary_causal_library: 'econml',
  },
