...
Before proceeding, validate the branch arguments.
...
if [ -z "$1" ]; then
  ...
  echo ""
  echo "Usage: /worktree <branch-1> [branch-2] [branch-3] [branch-4] [branch-5]"
  echo ""
  echo "Examples:"
  echo "  /worktree feature/discord-adapter"
  echo "  /worktree feature/discord feature/slack"
  echo "  /worktree feature/a feature/b feature/c feature/d feature/e"
  echo ""
  echo "Maximum: 5 parallel worktrees"
  exit 1
fi

# Count provided branches
BRANCH_COUNT=0
[ -n "$1" ] && BRANCH_COUNT=$((BRANCH_COUNT + 1)) && echo "✓ Branch 1: $1"
[ -n "$2" ] && BRANCH_COUNT=$((BRANCH_COUNT + 1)) && echo "✓ Branch 2: $2"
[ -n "$3" ] && BRANCH_COUNT=$((BRANCH_COUNT + 1)) && echo "✓ Branch 3: $3"
[ -n "$4" ] && BRANCH_COUNT=$((BRANCH_COUNT + 1)) && echo "✓ Branch 4: $4"
[ -n "$5" ] && BRANCH_COUNT=$((BRANCH_COUNT + 1)) && echo "✓ Branch 5: $5"

echo "ℹ️  Creating $BRANCH_COUNT worktree(s)"
```
