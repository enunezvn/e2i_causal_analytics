...
from src.agents.tool_composer.planner import PlanningError
from src.agents.tool_composer.executor import ExecutionError
...
class TestFullPipeline:
    ...
    @pytest.mark.asyncio
    async def test_composition_returns_answer(self, mock_llm_client, mock_tool_registry, sample_query):
    ...
    @pytest.mark.asyncio
    async def test_composition_with_context(self, mock_llm_client, mock_tool_registry, sample_query):
    ...
    @pytest.mark.asyncio
    async def test_composition_records_phases(self, mock_llm_client, mock_tool_registry, sample_query):
    ...
    @pytest.mark.asyncio
    async def test_composition_records_total_duration(self, mock_llm_client, mock_tool_registry, sample_query):
...
class TestConvenienceFunctions:
    ...
    @pytest.mark.asyncio
    async def test_compose_query_with_context(self, mock_llm_client, mock_tool_registry, sample_query):
...
class TestToolComposerIntegration:
    ...
    @pytest.mark.asyncio
    async def test_handle_multi_faceted_query(self, mock_llm_client, mock_tool_registry, sample_query):
    ...
    @pytest.mark.asyncio
    async def test_integration_response_format(self, mock_llm_client, mock_tool_registry, sample_query):
    ...
    @pytest.mark.asyncio
    async def test_integration_merges_context(self, mock_llm_client, mock_tool_registry, sample_query):
...
class TestLogging:
    ...
    @pytest.mark.asyncio
    async def test_logging_on_composition(self, mock_llm_client, mock_tool_registry, sample_query, caplog):
...
class TestPhaseDurationCalculation:
    ...
    @pytest.mark.asyncio
    async def test_phase_durations_are_positive(self, mock_llm_client, mock_tool_registry, sample_query):
    ...
    @pytest.mark.asyncio
    async def test_total_duration_sums_phases(self, mock_llm_client, mock_tool_registry, sample_query):
