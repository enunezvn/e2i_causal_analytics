...
**Source of truth:** the 2026-06-08 frontend↔backend connectivity audit. The original report (`docs/reports/frontend-backend-api-connectivity-audit-20260608.md`) is no longer in the repo; the surviving related document is [`docs/Archive/api_connectivity_review_20260516.md`](../Archive/api_connectivity_review_20260516.md) (its §5 "Pages on mock data" and §8 "Recommended next actions" cover the same ground, but the original's section/line anchors do not map 1:1).
