...
--
-- 150 is a pure EXPAND (three nullable TEXT columns + a NULL-only backfill), so a failed
...
-- ONLY what 150 added; the backfilled target is re-derived from ml_experiments on re-apply.
--
-- Apply by hand:
