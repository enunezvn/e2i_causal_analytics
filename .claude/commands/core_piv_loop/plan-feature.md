...
Before proceeding, validate the feature description.
...
if [ -z "$ARGUMENTS" ]; then
  ...
  echo ""
  echo "Usage: /core_piv_loop:plan-feature <feature-description>"
  echo ""
  echo "Examples:"
  echo "  /core_piv_loop:plan-feature \"Add user authentication\""
  echo "  /core_piv_loop:plan-feature \"Implement search functionality\""
  exit 1
fi
...
- Check `.claude/PRPs/reports/` for relevant research documents
...
**Filename**: `.claude/PRPs/features/active/{kebab-case-descriptive-name}.md`

- Replace `{kebab-case-descriptive-name}` with short, descriptive feature name
- Examples: `add-user-authentication.md`, `implement-search-api.md`, `refactor-database-layer.md`

**Directory**: Create `.claude/PRPs/features/active/` if it doesn't exist
