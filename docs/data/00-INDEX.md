...
| **06** | [KPI Reference](06-KPI-REFERENCE.md) | Analysts, product managers | All 45 calculable KPIs across 6 workstreams with formulas, thresholds (target/warning/critical), source tables, and calculator references (plus WS1-MP-008, decommissioned). |
