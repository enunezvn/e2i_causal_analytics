...
class ExperimentMonitorMemoryHooks:
    ...
    async def get_hybrid_context(
        ...
        Wraps :func:`src.rag.retriever.hybrid_search` with the experiment_monitor
        ...
        Args:
            ...
            filters: Optional caller filters; merged with agent default
                ``{"agent_name": "experiment_monitor"}`` (caller overrides).
        ...
        merged_filters: Dict[str, Any] = {"agent_name": "experiment_monitor"}
        if filters:
