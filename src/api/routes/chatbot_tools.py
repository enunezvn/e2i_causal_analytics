...
# Shaping for causal paths and refutation evidence lives in its own module: these are
# three pure functions with one subject and no Supabase access, and this file is
# size-ratchet pinned, so the room for forecast_kpi_tool comes from taking a coherent
# cluster out rather than from raising a pin that may only move down.
from src.api.routes.chat_causal_evidence import (  # noqa: E402
    _format_causal_path,
