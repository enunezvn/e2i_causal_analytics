...
if [ -z "$ARGUMENTS" ]; then
  ...
  echo ""
  echo "Usage: /fix-issue <issue-number-or-url>"
  echo ""
  echo "Examples:"
  echo "  /fix-issue 123"
...
# Extract issue number from URL or use number directly
if [[ "$ARGUMENTS" =~ github\.com/.*/issues/([0-9]+) ]]; then
  ...
  echo "Expected: number (123) or GitHub issue URL"
