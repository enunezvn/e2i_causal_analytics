...
class TestGenerateScenarioReturnsFrozenDataset:
    ...
    def test_dataset_metadata_populated(self, dummy_scenario_registered: ScenarioName) -> None:
...
class TestPrevalenceCalibration:
    def test_realized_prevalence_within_band(self, dummy_scenario_registered: ScenarioName) -> None:
...
class TestDeterminism:
    def test_byte_identical_reruns(self, dummy_scenario_registered: ScenarioName) -> None:
    ...
    def test_metadata_byte_identical(self, dummy_scenario_registered: ScenarioName) -> None:
    ...
    def test_different_seeds_differ(self, dummy_scenario_registered: ScenarioName) -> None:
        ds1 = generate_scenario(dummy_scenario_registered, seed=42)
...
class TestArgumentValidation:
    def test_ratios_must_sum_to_one(self, dummy_scenario_registered: ScenarioName) -> None:
    ...
    def test_n_total_below_floor_raises(self, dummy_scenario_registered: ScenarioName) -> None:
...
class TestFingerprint:
    def test_fingerprint_is_sha256_hex(self, dummy_scenario_registered: ScenarioName) -> None:
        ds = generate_scenario(dummy_scenario_registered, seed=42)
    ...
    def test_fingerprint_changes_with_seed(self, dummy_scenario_registered: ScenarioName) -> None:
        ds1 = generate_scenario(dummy_scenario_registered, seed=42)
        ds2 = generate_scenario(dummy_scenario_registered, seed=43)
        assert ds1.metadata.audit_fingerprint != ds2.metadata.audit_fingerprint
    ...
    def test_fingerprint_helper_directly(self, dummy_scenario_registered: ScenarioName) -> None:
...
class TestStandardizationContract:
    def test_x_train_zero_mean_unit_std(self, dummy_scenario_registered: ScenarioName) -> None:
    ...
    def test_val_test_use_train_stats(self, dummy_scenario_registered: ScenarioName) -> None:
        ds = generate_scenario(dummy_scenario_registered, seed=42, n_total=2000)
...
class TestStratifyKey:
    def test_stratify_is_full_cohort_outcome(self, dummy_scenario_registered: ScenarioName) -> None:
        ds = generate_scenario(dummy_scenario_registered, seed=42, n_total=1500)
