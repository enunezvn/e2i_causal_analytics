...
class TestBrandAxisLockstep:
    ...
    _EXPECTED = {
        ...
        "WS3-BI-005": ("143_canonical_volume_kpis.sql", "canonical_volume_trx"),
        "WS3-BI-006": ("143_canonical_volume_kpis.sql", "canonical_volume_nrx"),
        "WS3-BI-007": ("143_canonical_volume_kpis.sql", "canonical_volume_nbrx"),
        "WS3-BI-008": ("143_canonical_volume_kpis.sql", "canonical_volume_trx_share"),
        "WS3-BI-011": ("089_kpi_data_frontier_anchoring.sql", "business_impact_trx"),
        "WS3-BI-012": ("089_kpi_data_frontier_anchoring.sql", "business_impact_nrx"),
        "WS3-BI-013": ("089_kpi_data_frontier_anchoring.sql", "business_impact_nbrx"),
        "WS3-BI-014": ("089_kpi_data_frontier_anchoring.sql", "business_impact_trx_share"),
        "WS3-BI-009": (
