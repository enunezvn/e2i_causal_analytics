...
C4Container
    ...
    System_Boundary(droplet, "DigitalOcean Droplet (8 vCPU, 32 GB RAM)") {
        ...
        Container(mlflow, "MLflow", "MLflow v3.10.1", "Experiment tracking, model registry")
...
|-----------|-------|----------------------|---------|
| `mlflow` | ghcr.io/mlflow/mlflow:v3.10.1 | 127.0.0.1:5000:5000 | Experiment tracking, model registry |
