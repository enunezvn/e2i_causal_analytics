...
built_at: 2026-09-23T01:30:26.107882+00:00  ·  n_rows: 15209  ·  covariates: 64
activation_profile: `{"adaptive_layer4_enabled": true, "adaptive_structural_decider_enabled": true, "kg_mode": "shadow"}`
Layer 4 LM: **real**. REAL Layer 4: up to 64 paid calls × ~68,261 prompt tokens ≈ US$13.49 at Sonnet list prices (upper bound: Layer 4 fires only on moderate / high-and-declared-safe features).
...
| Layer 4 LLM | enabled True, classifier loaded True, fired 19, roles `{"confounder": 18, "descendant": 1}` |
...
| `charlson_score` | pre_index (pre_index) | no_signal | 7.55 / high | descendant | abstain | — | 0.00 |  |
